        ...
        if (v.getId() == R.id.btnCalaculate) {
            ...
            if (TextUtils.isEmpty(inputElectricity) || TextUtils.isEmpty(inputRebate)) {
                ...
                if (rebateValue < 1 || rebateValue > 5) {
                    Toast.makeText(this, "Please enter a rebate value between 1 and 5", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    decimalFormat.setRoundingMode(RoundingMode.HALF_UP); // Set rounding mode to half up
